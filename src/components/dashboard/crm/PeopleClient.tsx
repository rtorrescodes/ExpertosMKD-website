    ...
    <div>
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-gray-900">Personas (Contactos)</h1>
                    ...
                    <tr key={person.id} className="hover:bg-gray-50 cursor-pointer">
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                        <div className="flex items-center">
                          <div className="h-8 w-8 flex-shrink-0 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 font-bold">
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        {person.email && <div className="flex items-center gap-1"><Mail className="h-3 w-3"/> {person.email}</div>}
                        {person.phone && <div className="flex items-center gap-1 mt-1"><Phone className="h-3 w-3"/> {person.phone}</div>}
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        {person.company ? (
          ...
          <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div>
                  <h3 className="text-lg font-semibold leading-6 text-gray-900">Crear Contacto</h3>
                  {error && <p className="mt-2 text-sm text-red-600 bg-red-50 p-2 rounded">{error}</p>}
                  <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700">Nombre</label>
                        <input required type="text" name="firstName" className="mt-1 block w-full rounded-md border p-2 text-sm border-gray-300" />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700">Apellidos</label>
                        <input required type="text" name="lastName" className="mt-1 block w-full rounded-md border p-2 text-sm border-gray-300" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="email" name="email" className="block w-full rounded-md border p-2 pl-10 text-sm border-gray-300" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="tel" name="phone" className="block w-full rounded-md border p-2 pl-10 text-sm border-gray-300" />
                      </div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="text" name="jobTitle" className="block w-full rounded-md border p-2 pl-10 text-sm border-gray-300" />
                      </div>
                    </div>
